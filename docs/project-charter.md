...
Business baseline: **v1.1 — approved unchanged in DEC-G3-001**. Status-record revision: **1.2**. Approved: **2026-09-20 America/Chicago**. Run: HDG-20260920-01. Selected initiative: **OPP-02**. Authority: [Gate 3 actual decision](gates/gate-3-project-selection.md#actual-management-decision--approved-with-conditions). The exact [submitted v1.1](project-charter-v1.1-submitted.md) and [prior v1.0](project-charter-v1.0-submitted.md) are preserved.

The manager approved this baseline without changes after the [opportunity-cost addendum](portfolio/opportunity-cost-addendum.md) and [selection scorecard](portfolio/selection-scorecard.md). The stated rationale is meaningful design/business choices, protection against cost without significant benefit, and OPP-02's greater hypothetical value than OPP-01. C3-01 through C3-04 remain open. Business scope and success criteria below are unchanged; selection authorizes architecture only. GCP cost does not distinguish OPP-01 from OPP-02, and neither has demonstrated superior experimental learning value.
